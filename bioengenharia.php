...
<html lang="en">
  <head>
    ...
    <!--Bioinfo-->
    <link href="css/bioeng.css"s rel="stylesheet">
          ...
          <div class="row text-center">
            <div class="col-md-4 padding">    
                <div class="card carta bioeng text-center">
                  <div class="card-body">
                    <h5 class="card-title">Simulação de elementos finitos</h5>
                    <p class="card-text">É utilizado para resolução de problemas de análise estrutural por meio da obtenção de deslocamentos, deformações e tensões para analisar o desempenho de um produto com referência a resitência, rigidez e fadiga.</p>
            ...
            <div class="col-md-4 padding">
                <div class="card carta bioeng text-center">
                  <div class="card-body">
                    <h5 class="card-title">Tecnologias assistivas</h5>
                    <p class="card-text">Dispositivos, técnicas e processos utilizados para auxiliar pessoas com deficiência em suas habilidades funcionais. Agindo de forma a ampliar a mobilidade, comunicação ou habilidades de aprendizado.</p>
                    <!--<a href="#" class="btn btn-primary final">Saiba mais</a>-->
                  </div>
                </div>
            </div>
