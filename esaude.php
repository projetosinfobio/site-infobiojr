...
<!-- Parabéns time Julia! Agora acesse esse link para a última etapa www.infobiojr.com.br/segredos/audio_comum.wav -->
...
<html lang="en">
  <head>
    ...
    <!--Bioinfo-->
    <link href="css/esaude.css" rel="stylesheet">
            ...
            <div class="col-md-4 padding">
                <div class="card carta gestao text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Desenvolvimento de sistemas voltados à tratamentos fisicos e psicológicos a distância, incluindo a monitorização de pacientes.</p>
                    <!--<a href="#" class="btn btn-primary final">Saiba mais</a>-->
                  </div>
                </div>
            </div>
