...
<!-- Parabéns time Graciella! Agora acesse esse link para a última etapa www.infobiojr.com.br/segredos/audio_comum3.wav  -->
          ...
          <div class="row text-center">
            <div class="col-md-4 padding">    
                <div class="card carta imagens text-center">
                  <div class="card-body">
                    <h5 class="card-title">Sistemas de diagnóstico assistido por computador (DAC)</h5>
            ...
            <div class="col-md-4 padding">
                <div class="card carta imagens text-center">
                  <div class="card-body">
                    <h5 class="card-title">Sistemas de gerenciamento de imagens e informação</h5>
                    <p class="card-text">Desenvolvimento de sistemas para recuperação, armazenamento e gerenciamento de grande volume de imagens médicas personalizados para o ambiente de saúde</p>
                    <!--<a href="#" class="btn btn-primary final">Saiba mais</a>-->
                  </div>
                </div>
            </div>
